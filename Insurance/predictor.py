...
# Accept and deploy new model accuracy is more than old otherwise let the old model be in production

# save_model -> 0 -> 1 -> 2 -> 3

class ModelResolver:
    def __init__(self, model_registry:str = "saved_models", # To compare old model with new model
                transfomer_dir_name = "transfomer", # Transformed Data
                traget_encoder_dir_name = "target_encoder", #Encoded Data
